  ...
  <div class="viewport ">
    <div class="overview collapse">
     ...
     <ul id="sidebar_menu"  class="navbar nav nav-list container full">
            ...
            <li class="color_13"> <a class="dashboard " href="charts.html"><img src="img/menu_icons/others.png"><span>Charts Demo</span></a> </li>
            <li class="color_13"> <a class="dashboard " href="charts.php"><img src="img/menu_icons/others.png"><span>Charts</span></a> </li>
            <li class="color_13"> <a class="dashboard " href="custom_charts.php"><img src="img/menu_icons/others.png"><span>Custom Charts</span></a> </li>
           </ul>
<!--
